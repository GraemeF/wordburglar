...
require.define("/client/src/lib/ServerProxy.js",function(require,module,exports,__dirname,__filename,process,global){var util = require("util");
...
require.define("/client/src/lib/UI.js",function(require,module,exports,__dirname,__filename,process,global){var util = require("util");
var events = require("events");
...
UI.prototype.addPlayer = function (id) {
  ...
  if(existingPlayer.length > 0) existingPlayer.show();
  else $('#players').append($('<tr id="' + getPlayerRowId(id) + '" class="player">' + '<td class="playerName">Anonymous</td>' + '<td><span class="score ownedByPlayer_' + id + '">0</span></td></tr>'));
};
...
require.define("/client/src/lib/Game.js",function(require,module,exports,__dirname,__filename,process,global){var Game = function (serverProxy, ui) {
...
require.define("/client/src/lib/main.js",function(require,module,exports,__dirname,__filename,process,global){var ServerProxy = require('./ServerProxy');
var UI = require('./UI');
...
require("/client/src/lib/main.js");
})();
